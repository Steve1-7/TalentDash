...
export default function DashboardPage() {
  console.log('FULL DASHBOARD WITH AI & DATABASE - DEBUG CHECK');
        ...
        return (
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '2rem' }}>
            ...
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '1rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.05)' }}>
              <h3 style={{ fontSize: '1.25rem', fontWeight: 'bold', marginBottom: '1rem', color: '#166534' }}>AI Code Review</h3>
              <Textarea
              ...
              />
              <Button onClick={handleCodeReview} disabled={loading} style={{ backgroundColor: '#16a34a', color: 'white', width: '100%' }}>
                {loading ? 'Analyzing...' : 'Get AI Review'}
              </Button>
              {aiResponse && (
                <div style={{ marginTop: '1rem', padding: '1rem', backgroundColor: '#f0fdf4', borderRadius: '0.5rem', whiteSpace: 'pre-wrap' }}>
                  {aiResponse}
                </div>
              )}
            </div>
            ...
            {/* AI Market Insights */}
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '1rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.05)' }}>
              <h3 style={{ fontSize: '1.25rem', fontWeight: 'bold', marginBottom: '1rem', color: '#166534' }}>AI Market Insights</h3>
              <Input
              ...
              />
              <Button onClick={handleMarketInsights} disabled={loading} style={{ backgroundColor: '#16a34a', color: 'white', width: '100%' }}>
        ...
        return (
          <div style={{ marginBottom: '2rem' }}>
            ...
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '1rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.05)', marginBottom: '2rem' }}>
              <h3 style={{ fontSize: '1.25rem', fontWeight: 'bold', marginBottom: '1rem', color: '#166534' }}>Available Gigs</h3>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1rem' }}>
                {gigs.map(gig => (
                  <div key={gig.id} style={{ padding: '1rem', border: '1px solid #e5e7eb', borderRadius: '0.5rem', backgroundColor: '#f9fafb' }}>
                    ...
                    {gig.status === 'Open' && (
                      <Button onClick={() => applyForGig(gig.id)} style={{ backgroundColor: '#16a34a', color: 'white', width: '100%' }}>
                        Apply Now
                      </Button>
                    )}
                  </div>
            ...
            {/* Earnings Overview */}
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '1rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.05)' }}>
              <h3 style={{ fontSize: '1.25rem', fontWeight: 'bold', marginBottom: '1rem', color: '#166534' }}>Earnings Overview</h3>
      ...
      case 'recruiter':
        return (
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '2rem' }}>
            ...
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '1rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.05)' }}>
              <h3 style={{ fontSize: '1.25rem', fontWeight: 'bold', marginBottom: '1rem', color: '#166534' }}>AI Candidate Matching</h3>
              <Textarea
                ...
                style={{ marginBottom: '1rem', minHeight: '120px' }}
              />
              <Button onClick={handleCandidateSearch} disabled={loading} style={{ backgroundColor: '#16a34a', color: 'white', width: '100%' }}>
            ...
            {/* Candidate Pipeline */}
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '1rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.05)' }}>
              <h3 style={{ fontSize: '1.25rem', fontWeight: 'bold', marginBottom: '1rem', color: '#166534' }}>Candidate Pipeline</h3>
                  ...
                  <div key={candidate.id} style={{ padding: '1rem', border: '1px solid #e5e7eb', borderRadius: '0.5rem', backgroundColor: '#f9fafb' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
                      ...
                      <select 
                        ...
                        style={{ padding: '0.25rem 0.5rem', border: '1px solid #e5e7eb', borderRadius: '0.25rem' }}
                      >
      ...
      case 'manager':
        return (
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '2rem' }}>
            {/* AI Team Analysis */}
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '1rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.05)' }}>
              <h3 style={{ fontSize: '1.25rem', fontWeight: 'bold', marginBottom: '1rem', color: '#166534' }}>AI Team Analysis</h3>
              <Textarea
                ...
                style={{ marginBottom: '1rem', minHeight: '120px' }}
              />
              <Button onClick={handleTeamAnalysis} disabled={loading} style={{ backgroundColor: '#16a34a', color: 'white', width: '100%' }}>
                ...
                {teamMembers.map(member => (
                  <div key={member.id} style={{ padding: '1rem', border: '1px solid #e5e7eb', borderRadius: '0.5rem', backgroundColor: '#f9fafb' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                      <Label style={{ fontSize: '0.875rem' }}>Update Productivity:</Label>
                      <Input
                        type="number"
                        min="0"
                        max="100"
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f0fdf4', fontFamily: 'Arial, sans-serif', display: 'flex' }}>
      ...
      <div style={{ 
        ...
        <div style={{ padding: '1rem', borderBottom: '1px solid #e5e7eb' }}>
          <Label style={{ fontSize: '0.875rem', fontWeight: '600', color: '#1f2937', marginBottom: '0.5rem', display: 'block' }}>Select Role:</Label>
          <select 
            value={activeRole} 
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <main style={{ flex: 1, padding: '2rem', overflow: 'auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '2rem' }}>
            {/* Projects Section */}
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '1rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.05)' }}>
              <h3 style={{ fontSize: '1.25rem', fontWeight: 'bold', marginBottom: '1rem', color: '#166534' }}>Projects</h3>
            ...
            {/* Tasks Section */}
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '1rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.05)' }}>
              <h3 style={{ fontSize: '1.25rem', fontWeight: 'bold', marginBottom: '1rem', color: '#166534' }}>Tasks</h3>
          ...
          {/* Skills Section */}
          <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '1rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.05)', marginBottom: '2rem' }}>
            <h3 style={{ fontSize: '1.25rem', fontWeight: 'bold', marginBottom: '1rem', color: '#166534' }}>Skills</h3>
          ...
          {/* Recent Activity */}
          <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '1rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.05)' }}>
            <h3 style={{ fontSize: '1.25rem', fontWeight: 'bold', marginBottom: '1rem', color: '#166534' }}>Recent Activity</h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
