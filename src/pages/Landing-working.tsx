...
export default function LandingPage() {
  console.log('Landing page rendering - DEBUG');
    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="flex items-center justify-between px-6 py-4 max-w-6xl mx-auto border-b">
        <div className="flex items-center gap-2">
          <span className="font-bold text-2xl">PromptlyOS</span>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="p-6 rounded-xl border bg-gray-50 hover:bg-gray-100 transition-colors">
